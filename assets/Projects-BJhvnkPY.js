import{c as e,F as a,i as o,G as c,s as i,t as s}from"./index-k2UVe7q6.js";const d="/madax-tech/assets/img3-U6LUs_eI.jpg",p="/madax-tech/assets/img4-BGXRToJ7.jpg",l="/madax-tech/assets/img5-BQmoxccw.jpg";var m=s("<h2>"),g=s("<p>");const h=[{id:1,title:"Madax Dashboard",image:d,tech:["TypeScript","React","Nestjs"],description:"Painel administrativo com gráficos em tempo real, autenticação e gerenciamento de usuários."},{id:2,title:"Loja Virtual",image:p,tech:["Solid Start","Stripe","Prisma"],description:"E-commerce com checkout integrado, catálogo dinâmico e painel de pedidos."},{id:3,title:"App Mobile",image:l,tech:["Ionic","GraphQL","Expo"],description:"Aplicativo móvel multiplataforma com sync offline e notificações push."}],x=i("section")`
    display: grid;
